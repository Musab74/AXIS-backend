...
async function main() {
  ...
  await prisma.certificationLevel.upsert({
    where: { certId_level: { certId: axis.id, level: CertLevel.L3 } },
    update: {},
    create: {
      certId: axis.id,
      level: CertLevel.L3,
  ...
  await prisma.certificationLevel.upsert({
    where: { certId_level: { certId: axis.id, level: CertLevel.L2 } },
    update: {},
    create: {
      certId: axis.id,
      level: CertLevel.L2,
  ...
  await prisma.certificationLevel.upsert({
    where: { certId_level: { certId: axis.id, level: CertLevel.L1 } },
    update: {},
    create: {
      certId: axis.id,
      level: CertLevel.L1,
  ...
  // ─── AXIS-C (Coding & Automation) ──────────────────────
  const axisC = await prisma.certification.upsert({
    where: { type: CertType.AXIS_C },
    update: {},
    create: {
      type: CertType.AXIS_C,
      name: 'AXIS-C',
      nameKo: 'AXIS-C 코딩자동화',
  ...
  await prisma.certificationLevel.upsert({
    where: { certId_level: { certId: axisC.id, level: CertLevel.L3 } },
    update: {},
    create: {
      certId: axisC.id,
      level: CertLevel.L3,
  ...
  await prisma.certificationLevel.upsert({
    where: { certId_level: { certId: axisC.id, level: CertLevel.L2 } },
    update: {},
    create: {
      certId: axisC.id,
      level: CertLevel.L2,
  ...
  await prisma.certificationLevel.upsert({
    where: { certId_level: { certId: axisC.id, level: CertLevel.L1 } },
    update: {},
    create: {
      certId: axisC.id,
      level: CertLevel.L1,
  ...
  const axisH = await prisma.certification.upsert({
    where: { type: CertType.AXIS_H },
    update: {},
    create: {
      type: CertType.AXIS_H,
      name: 'AXIS-H',
      nameKo: 'AXIS-H 의료',
  ...
  await prisma.certificationLevel.upsert({
    where: { certId_level: { certId: axisH.id, level: CertLevel.L3 } },
    update: {},
    create: {
      certId: axisH.id,
      level: CertLevel.L3,
  ...
  await prisma.certificationLevel.upsert({
    where: { certId_level: { certId: axisH.id, level: CertLevel.L2 } },
    update: {},
    create: {
      certId: axisH.id,
      level: CertLevel.L2,
  ...
  await prisma.certificationLevel.upsert({
    where: { certId_level: { certId: axisH.id, level: CertLevel.L1 } },
    update: {},
    create: {
      certId: axisH.id,
      level: CertLevel.L1,
